  ...
  const components = {
    ...
    pre: (props: any) => {
      ...
      if (typeof children === "string") {
        ...
        children?.type === "code" ||
        (children?.props && typeof children.props.children !== "undefined")
      ) {
      ...
      if (!codeString) {
        return (
          <pre className="p-4 bg-muted rounded">
            <code>Code block could not be rendered</code>
          </pre>
        );
      }
...
export async function generateStaticParams() {
  return [
    ...
    { slug: ["api", "rename"] },
    { slug: ["api", "copy"] },
    { slug: ["api", "create-folder"] },
    { slug: ["api", "delete-folder"] },
    { slug: ["api", "move-to-folder"] },
    { slug: ["api", "share-asset"] },
    { slug: ["api", "create-shareable-link"] },
    { slug: ["api", "revoke-share"] },
